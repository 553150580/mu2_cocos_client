...
module.exports = {
	...
	pbjsLibDir: "assets/",//"bin/js",
	/**输出protojs文件类型  0 全部（js和.min.js）1(js) 2(.min.js)*/
	outputFileType: 1,
	/**.proto 文件夹路径  "D:/SrfWorkFouder/mu2_server/protos/define/out"*/
	sourceRoot: "../mu2_server/protos/define/out",
	/**输出js文件名 */
	outFileName: "proto_bundle",
	/**生成js的输出路径 */
	outputDir: "assets/resources/",//"bin/js",
	/**声明文件输出路径 */
	dtsOutDir: "",
	/**是否使用压缩库，默认false */
	isUseMinLib: false,
	...
	// }
	//CD到项目根目录，输入生成命令：egf-pb generate
} 